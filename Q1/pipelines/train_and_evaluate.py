...
from core.embedders import OpenAIEmbedder
...
def main():
    ...
    # Initialize OpenAI embedder and classifier
    print("\nInitializing OpenAI embedder and classifier...")
    ...
    model_path = config.MODELS_DIR / "openai_classifier.joblib"
