...
from core.embedders import BertEmbedder
...
def main():
    ...
    # Initialize BERT embedder and classifier
    print("\nInitializing BERT embedder and classifier...")
    embedder = BertEmbedder()  # Using default BERT model
    ...
    model_path = config.MODELS_DIR / "bert_classifier.joblib"
